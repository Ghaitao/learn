...
<!--<![endif]-->
	<head>
		...
		<title><spring:message code="com.jinzhiyi.ffs.message.customer.modify.page.title" /></title>
...
<body class="page-content-white page-header-fixed">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption">
										<i class="icon-note"></i> <spring:message code="com.jinzhiyi.ffs.message.customer.modify.page.title" />
									</div>
								</div>
								<div class="portlet-body form">
									<form:form modelAttribute="customerDto"
										id="frmModifyCustomerByCompany"
										method="post"
										action="${pageContext.request.contextPath}/customer/doModifyCustomerByCompany.do">
											...
											<div class="row">
												...
												<div class="col-lg-2 col-xs-2 col-md-2">
													<div class="form-group">
														...
														<p class="form-control-static form-control no-border no-padding-left">
															<strong>${customerDto.customer.customerCode}</strong>
														</p>
													</div>
												</div>
												<!-- 中文名称 -->
											...
											<div class="form-actions">
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
														...
														<a class="btn btn-default margin-left10" href="${pageContext.request.contextPath}/customer/customerDetail.do?customerId=${customerDto.customer.recId}"><i class="icon-share-alt"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.return"/></a>
	...
	<script type="text/javascript">
		$(function() {
			$('#frmModifyCustomerByCompany').validate({
				rules : {
