			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-docs"></i><spring:message code="com.jinzhiyi.ffs.message.user.panel.reset.password.title"/></div>
                                    </div>
                                    <div class="portlet-body form">
                                        <div class="form-body ">
                                            <form action="${pageContext.request.contextPath}/sys/userPerson/resetPasswordModify.do" class="" method="post" id="modiftyForm">
												...
												<h4 class="form-section"><spring:message code="com.jinzhiyi.ffs.message.user.panel.reset.password.title"/> </h4>
                                                <div class="row">
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-4 col-md-3 text-center">
                                                    		...
                                                    		<a href="${pageContext.request.contextPath}/sys/admin/user/userDetail.do?recId=${user.recId}" class="btn btn-default margin-left10"><i class="icon-share-alt"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.return"/></a>
                                                        	</c:if>
                                                        	<c:if test="${flag =='' }">
                                                    		<a href="${pageContext.request.contextPath}/sys/admin/userCompany/userCompanyDetail.do?recId=${user.recId}" class="btn btn-default margin-left10"><i class="icon-share-alt"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.return"/></a>
                                                        	</c:if>
                                                        </div>
                                                    </div>
                                                </div>
