    ...
    <body class="page-sidebar-closed-hide-logo page-content-white page-header-fixed">
			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-docs"></i> <spring:message code="com.jinzhiyi.ffs.message.menu.panel.create.title" /></div>
                                    </div>
                                    <div class="portlet-body form">
                                        <div class="form-body ">
                                            <form action="${pageContext.request.contextPath}/sys/menu/menuCreate.do" id="createMenuForm" method="post">
		...
		<script type="text/javascript">   
			$(function(){     
	            ...
	            var error = $('.alert-danger', createMenuForm);
	            var success = $('.alert-success', createMenuForm);
