			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                    	<div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                   		<form action="${pageContext.request.contextPath}/sys/role/roleModify.do" id="modifyRoleForm" method="post">
                                        	<div class="form-body">
		...
		<script type="text/javascript">   
			$(function(){   
				...
				$("#btn_delete").click(function() {
					$.dialog.confirm('<spring:message code="com.jinzhiyi.ffs.message.role.prompt_delete"/>', function() {
						window.location.href = '${pageContext.request.contextPath}/sys/role/roleDelete.do?roleId=${role.recId}';
					});
				});
				...
				//验证信息
				var modifyRoleForm = $('#modifyRoleForm');
				var error = $('.alert-danger', modifyRoleForm);
				var success = $('.alert-success', modifyRoleForm);
