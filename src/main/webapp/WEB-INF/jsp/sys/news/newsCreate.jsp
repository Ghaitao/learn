			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                        <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-note"></i><spring:message code="com.jinzhiyi.ffs.message.news.panel.create.title" /></div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form action="${pageContext.request.contextPath}/sys/news/newsCreate.do" id="createNewsForm" enctype="multipart/form-data" method="post">
                                            <div class="form-body">
...
$(function(){
	...
	var error = $('.alert-danger', createNewsForm);
	var success = $('.alert-success', createNewsForm);
