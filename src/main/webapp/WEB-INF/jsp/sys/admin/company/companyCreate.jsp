    ...
    <body class="page-sidebar-closed-hide-logo page-content-white page-header-fixed">
			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                        <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-note"></i><spring:message code="com.jinzhiyi.ffs.message.company.panel.create.title" /></div>
                                    </div>
                                    <div class="portlet-body form">
                                        <form action="${pageContext.request.contextPath}/sys/admin/company/companyCreate.do" id="createCompanyForm" enctype="multipart/form-data" method="post">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required_input" name="nameCn" id="nameCn" 
                                                            	value="${company.nameCn}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_name_cn" />">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.company_name_en" /></label>
                                                            <input type="text" class="form-control disable-ime" name="nameEn" id="nameEn" 
                                                            	value="${company.nameEn}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_name_en" />">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                	<div class="col-lg-2 col-xs-2 col-md-2">
														<div class="form-group">
															<label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.company_code" /><span class="required">*</span></label>
															 <input type="text" class="form-control required_input text-uppercase" name="companyCode" id="companyCode" 
															 	value="${company.companyCode}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_code" />">
														</div>
													</div>
                                                	<div class="col-lg-2 col-xs-2 col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required_input text-uppercase" name="cityCode" id="cityCode" 
                                                            	value="${company.cityCode}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_city_code" />">
                                                        </div>
                                                    </div>
													<div class="col-lg-2 col-xs-2 col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required_input text-uppercase" name="airportCode" id="airportCode" 
                                                            	value="${company.airportCode}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_airport_code" />">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.company_rightCopy" /></label>
															<input type="text" class="form-control disable-ime" name="copyRight" id="copyRight" 
																value="${company.copyRight}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_rightCopy" />">
                                                        </div>
                                                    </div>
												</div>
												<div class="row">
                                            		<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control disable-ime" name="customerServicePhone" id="customerServicePhone" 
																value="${company.customerServicePhone}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_customerService_phone" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.company_customerService_email" /></label>
                                                            <input type="text" class="form-control disable-ime" name="customerServiceEmail" id="customerServiceEmail" 
                                                            	value="${company.customerServiceEmail}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_customerService_email" />">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xs-6 col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control required_input disable-ime" name="uploadDirPath" id="uploadDirPath" 
																value="${company.uploadDirPath}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.upload_dir_path" />">
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-6 col-xs-6 col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control disable-ime" name="address" id="address" 
																value="${company.adress}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.address" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															<label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.postcode" /></label>
															<input type="text" class="form-control disable-ime" name="postcode" id="postcode" 
																value="${company.postcode}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.postcode" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															<label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.contactorName" /></label>
															<input type="text" class="form-control disable-ime" name="contactorName" id="contactorName" 
																value="${company.contactorName}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.contactorName" />">
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control disable-ime" name="contactorPhone" id="contactorPhone" 
																value="${company.contactorPhone}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.contactorPhone" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															<label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.contactorFax" /></label>
															<input type="text" class="form-control disable-ime" name="contactorFax" id="contactorFax" 
																value="${company.contactorFax}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.contactorFax" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
														<div class="form-group">
															<label class="control-label"><spring:message code="com.jinzhiyi.ffs.message.company.contactorEmail" /></label>
															<input type="text" class="form-control disable-ime" name="contactorEmail" id="contactorEmail" 
																value="${company.contactorEmail}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.contactorEmail" />">
														</div>
													</div>
													<div class="col-lg-3 col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required_input disable-ime" name="uploadFileSldName" id="uploadFileSldName" 
                                                            	value="${company.uploadFileSldName}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.upload_file_sld_name" />">
                                                        </div>
                                                    </div>
												</div>
												<div class="row">
                                                    <div class="col-lg-3 col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control disable-ime date-picker" name="startDateTime" id="startDateTime" 
                                                            	value="${company.startDateTime}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_start_dateTime" />" autocomplete="off">
                                            			</div>
                                           			</div>
                                                    <div class="col-lg-3 col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                        	...
                                                        	<input type="text" class="form-control disable-ime date-picker" name="expiryDateTime" id="expiryDateTime" 
                                                        		value="${company.expiryDateTime}" placeholder="<spring:message code="com.jinzhiyi.ffs.message.company.company_expiry_dateTime" />" autocomplete="off">
                                                        </div>
                                                    </div>
												</div>
														...
														<div class="form-group">
															...
															<div class="fileinput fileinput-new" data-provides="fileinput">
		                                                        <span class="btn btn-default btn-file input-sm">
		                                                            ...
		                                                            <input type="file" name="faviconFile" id="faviconFile" value="${company.faviconFile}">
		                                                        </span>
														...
														<div class="form-group">
															...
															<div class="fileinput fileinput-new" data-provides="fileinput">
		                                                        <span class="btn btn-default btn-file input-sm">
		                                                            <span class="fileinput-new"><i class="fa fa-file fileinput-exists"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.choose" /> </span>
		                                                            <span class="fileinput-exists"><i class="fa fa-exchange"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.edit" /> </span>
		                                                            <input type="file" name="textLogoBigCnFile" id="textLogoBigCnFile" value="${company.textLogoBigCnFile}">
		                                                        </span>
		                                                        <span class="fileinput-filename"> </span> &nbsp;
		                                                        <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput" title="<spring:message code="com.jinzhiyi.ffs.message.common.file.delete" />"> </a>
		                                                    </div>
														...
														<div class="form-group">
															...
															<div class="fileinput fileinput-new" data-provides="fileinput">
		                                                        <span class="btn btn-default btn-file input-sm">
		                                                            <span class="fileinput-new"><i class="fa fa-file fileinput-exists"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.choose" /></span>
		                                                            <span class="fileinput-exists"><i class="fa fa-exchange"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.edit" /></span>
		                                                            <input type="file" name="textLogoCnFile" id="textLogoCnFile" value="${company.textLogoCnFile}">
		                                                        </span>
		                                                        <span class="fileinput-filename"> </span> &nbsp;
		                                                        <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput" title="<spring:message code="com.jinzhiyi.ffs.message.common.file.delete" />"> </a>
		                                                    </div>
														...
														<div class="form-group">
															...
															<div class="fileinput fileinput-new" data-provides="fileinput">
		                                                        <span class="btn btn-default btn-file input-sm">
		                                                            <span class="fileinput-new"><i class="fa fa-file fileinput-exists"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.choose" /></span>
		                                                            <span class="fileinput-exists"><i class="fa fa-exchange"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.edit" /></span>
		                                                            <input type="file" name="textLogoBigEnFile" id="textLogoBigEnFile" value="${company.textLogoBigEnFile}">
		                                                        </span>
		                                                        <span class="fileinput-filename"> </span> &nbsp;
		                                                        <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput" title="<spring:message code="com.jinzhiyi.ffs.message.common.file.delete" />"></a>
		                                                    </div>
														...
														<div class="form-group">
															...
															<div class="fileinput fileinput-new" data-provides="fileinput">
		                                                        <span class="btn btn-default btn-file input-sm">
		                                                            <span class="fileinput-new"><i class="fa fa-file fileinput-exists"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.choose" /></span>
		                                                            <span class="fileinput-exists"><i class="fa fa-exchange"></i> <spring:message code="com.jinzhiyi.ffs.message.common.file.edit" /></span>
		                                                            <input type="file" name="textLogoEnFile" id="textLogoEnFile" value="${company.textLogoEnFile}">
		                                                        </span>
		                                                        <span class="fileinput-filename"> </span> &nbsp;
		                                                        <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput" title="<spring:message code="com.jinzhiyi.ffs.message.common.file.delete" />"> </a>
		                                                    </div>
		...
		<script type="text/javascript">   
			$(function(){     
	            ...
	            var error = $('.alert-danger', createCompanyForm);
	            var success = $('.alert-success', createCompanyForm);
