...
<html lang="en">
	...
	<body class="page-content-white page-header-fixed">
                                                ...
                                                <div class="row">
                                                	<div class="col-lg-4 col-xs-4 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-8 col-xs-8 col-md-8">
																<p class="form-control-static"><ffs:enum declaringClassName="${dto.status.declaringClass.name}" name="${dto.status}" /></p>
															</div>
                                                        </div>
                                                    </div>
													<div class="col-lg-4 col-xs-4 col-md-4">
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                    	<a href="${pageContext.request.contextPath}/sys/admin/user/preUserModify.do?recId=${dto.recId }" class="btn red"><i class="fa fa-edit"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.edit"/></a>
                                                    	...
                                                    	<a href="${pageContext.request.contextPath}/sys/userPerson/preResetPasswordModify.do?recId=${dto.recId}&flag=admin" class="btn btn-default margin-left10"><i class="fa fa-repeat"></i> <spring:message code="com.jinzhiyi.ffs.message.user.btn.reset_password"/></a>
                                                    	<c:if test="${dto.locked }">
                                                			<a href="${pageContext.request.contextPath}/sys/admin/user/userNormal.do?recId=${dto.recId }" class="btn btn-default margin-left10" id="btn_unlock"><i class="icon-lock-open"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.normal"/></a>
                                                		</c:if>
                                                		<c:if test="${!dto.locked }">
                                                		<a href="${pageContext.request.contextPath}/sys/admin/user/userLocked.do?recId=${dto.recId }" class="btn btn-default margin-left10" id="btn_lock"><i class="icon-lock"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.locked"/></a>
                                                		</c:if>
                                                		<a href="${pageContext.request.contextPath}/sys/admin/user/userQuery.do" class="btn btn-default margin-left10" id="btn_return"><i class="icon-share-alt"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.return"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
        ...
        <script src="${ffsStaticUrl}/metronic_v4.5.6/theme/assets/global/plugins/artDialog4.1.7/jquery.artDialog.source.js"></script>
		...
		$(function(){
			$("#btn_delete").click(function() {
				$.dialog.confirm('<spring:message code="com.jinzhiyi.ffs.message.user.prompt_delete"/>', function() {
					window.location.href = '${pageContext.request.contextPath}/sys/admin/user/userDelete.do?recId=${dto.recId}';
				});
			});
		});
		</script>
