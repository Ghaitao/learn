    ...
    <body class="page-content-white page-header-fixed">
			                ...
			                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <div class="form-body ">
                                            <form action="${pageContext.request.contextPath}/sys/admin/user/userModify.do" method="post" id="ModifyForm">
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                    		...
                                                    		<a href="${pageContext.request.contextPath}/sys/admin/user/userQuery.do" class="btn btn-default margin-left10"><i class="icon-share-alt"></i> <spring:message code="com.jinzhiyi.ffs.message.common.btn.return_search"/></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
		...
		<script type="text/javascript">
			$(function(){
	            ...
	            var error = $('.alert-danger', ModifyForm);
	            var success = $('.alert-success', ModifyForm);
